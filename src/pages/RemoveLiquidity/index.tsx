...
export default function RemoveLiquidity({
  ...
  const [currencyA, currencyB] = [
    useCurrency(chainId, currencyIdA) ?? undefined,
    useCurrency(chainId, currencyIdB) ?? undefined
  ]
  ...
  async function onAttemptToApprove() {
    ...
    const domain = {
      name: 'DCTDAO LP Token', //correct domain name!!!!!!!!!!!!!!!!!!!!!!!
      version: '1',
      chainId: chainId,
  ...
  async function onRemove() {
    ...
    if (approval === ApprovalState.APPROVED) {
      // removeLiquidityETH
      if (oneCurrencyIsETH) {
        methodNames = ['removeLiquidityNATIVE', 'removeLiquidityNATIVESupportingFeeOnTransferTokens']
        args = [
                    ...
                    {chainId && (oneCurrencyIsWRAPPED || oneCurrencyIsETH) ? (
                      <RowBetween style={{ justifyContent: 'flex-end' }}>
                        {oneCurrencyIsETH ? (
                          <StyledInternalLink
                            to={`/remove/${
                              currencyA === BASE_CURRENCY[chainId] ? WRAPPED[chainId].address : currencyIdA
